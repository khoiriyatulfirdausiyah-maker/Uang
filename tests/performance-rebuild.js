...
ok(src.includes("insertAdjacentHTML('beforeend'"),'append-does-not-rerender-old-transactions');
ok(src.includes("next==='transactions'&&currentPage!=='transactions'"),'transaction-page-reset-on-entry');
